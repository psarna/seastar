...
enum ondisk_type : uint8_t {
    INVALID = 0,
    CHECKPOINT = 1,
    NEXT_METADATA_CLUSTER = 2,
    CREATE_INODE = 3,
    DELETE_INODE = 4,
    SMALL_WRITE = 5,
    MEDIUM_WRITE = 6,
    LARGE_WRITE_WITHOUT_MTIME = 7,
    LARGE_WRITE = 8,
    TRUNCATE = 9,
    CREATE_DENTRY = 10,
    CREATE_INODE_AS_DENTRY = 11,
    DELETE_DENTRY = 12,
    DELETE_INODE_AND_DENTRY = 13,
    // Here add new ones, as changing the above values is backward incompatible
};
