...
class read_operation {
    ...
    future<size_t> read(uint8_t* buffer, file_offset_t file_offset, size_t read_len) {
        ...
        return _metadata_log._locks.with_lock(metadata_log::locks::shared {_inode},
            ...
            file_info->execute_on_data_range({file_offset, file_offset + read_len}, [&](inode_data_vec data_vec) {
            ...
            return _metadata_log.with_data_cluster_read_locks_nowait(std::move(cluster_ids),
