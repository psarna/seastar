...
public:
    ...
    using fs::to_disk_buffer::init; // Explicitly stated that stays the same
     ...
     */
    virtual std::optional<init_error> init_from_bootstrapped_cluster(size_t aligned_max_size, unit_size_t alignment,
