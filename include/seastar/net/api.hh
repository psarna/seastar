...
//
// Parameters for requesting packet timestamping.
// system_timestamp and system_timestamp_ns come from the operating system,
// and the rest leverages help from the NIC itself - with timestamping generated
// either by the driver from the NIC clock or hardware-generated timestamps.
// Note that requesting timestamp generation is separated from reporting these timestamps,
// so, for example, in order to being able to see timestamps from the NIC clock
// for incoming packets, one should set the following options:
// 
// timestamping_params params;
// params.nic_timestamp_request_rx_software = true;
// params.nic_timestamp_report_software = true;
//
// Note that for hardware timestamps to work, additional setup may be required for the network
// device itself, e.g. look for SIOCSHWTSTAMP for Linux.
//
struct timestamping_params {
    // Report timestamps generated by the operating system
    bool system_timestamp : 1;
    // Report timestamps generated by the operating system with realtime clock, ns precision
    bool system_timestamp_ns : 1;
    // Request timestamp generation from NIC: outgoing, hardware-generated
    bool nic_timestamp_request_tx_hardware : 1;
    // Request timestamp generation from NIC: outgoing, software-generated
    bool nic_timestamp_request_tx_software : 1;
    // Request timestamp generation from NIC: incoming, hardware-generated
    bool nic_timestamp_request_rx_hardware : 1;
    // Request timestamp generation from NIC: incoming, software-generated
    bool nic_timestamp_request_rx_software : 1;
    // Report software-generated timestamps from NIC
    bool nic_timestamp_report_software : 1;
    // Report hardware-generated timestamps from NIC
    bool nic_timestamp_report_hardware : 1;

    timestamping_params()
            : system_timestamp(false)
            , system_timestamp_ns(false)
            , nic_timestamp_request_tx_hardware(false)
            , nic_timestamp_request_tx_software(false)
            , nic_timestamp_request_rx_hardware(false)
            , nic_timestamp_request_rx_software(false)
            , nic_timestamp_report_software(false)
            , nic_timestamp_report_hardware(false)
            {}
...
public:
    ...
    /// Sets SO_TIMESTAMP option (enable gathering per-packet timestamps)
    void set_timestamping_parameters(net::timestamping_params&& p);
    /// Get TCP timestamp parameters
    net::timestamping_params get_timestamping_parameters() const;
