...
// TODO: move all of the below free-standing static asserts to a separate .cc file so they aren't evaluated every time this is included
static_assert(!is_power_of_2(0u));
static_assert(is_power_of_2(1u));
static_assert(is_power_of_2(2u));
static_assert(!is_power_of_2(3u));
static_assert(is_power_of_2(4u));
static_assert(!is_power_of_2(5u));
static_assert(!is_power_of_2(6u));
static_assert(!is_power_of_2(7u));
