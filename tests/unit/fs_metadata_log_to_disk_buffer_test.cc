...
#include "fs_metadata_log_entries_print.hh"
...
struct test_base {
    static constexpr auto APPENDED = metadata_log::to_disk_buffer::APPENDED;
    static constexpr auto TOO_BIG = metadata_log::to_disk_buffer::TOO_BIG;
