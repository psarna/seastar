...
#include "fs_metadata_log_random_entry.hh"
...
namespace ml = seastar::fs::metadata_log;

struct test_base {
    static constexpr auto APPENDED = metadata_log::to_disk_buffer_mocker::APPENDED;
    static constexpr auto TOO_BIG = metadata_log::to_disk_buffer_mocker::TOO_BIG;
    static constexpr auto alignment = 256;
    static constexpr auto buff_size = 1 * MB;

    block_device device = block_device_mocker(alignment);
    shared_ptr<std::vector<shared_ptr<metadata_log::to_disk_buffer_mocker>>> mbufs_holder;
    std::vector<shared_ptr<metadata_log::to_disk_buffer_mocker>>& mbufs;
    metadata_log::to_disk_buffer buf;
    metadata_log::to_disk_buffer_mocker mock_buf;
