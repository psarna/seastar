...
constexpr double min_compactness = -1; //not testing compaction
...
SEASTAR_THREAD_TEST_CASE(create_dirs_and_bootstrap_test) {
...

    {
        ...
        auto log = metadata_log(std::move(device), cluster_size, alignment, min_compactness, max_data_compaction_memory);
