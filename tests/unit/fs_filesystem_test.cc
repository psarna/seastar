...
constexpr disk_offset_t cluster_size = 1 * MB;
constexpr disk_offset_t alignment = 4 * KB;
constexpr inode_t root_directory = 0;

future<> run_parallel_read_write(file& f, size_t _device_size, const disk_offset_t _alignment) {
